...
function buildWord({name, start_date, end_date, description}){
  return ` <div class="w3-container">
          <h5 class="w3-opacity"><b>${name}</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>${start_date} -<i class=" w3-teal "></i>${end_date}</h6>
          <p>${description}</p>
          <hr>
        </div>`;
}
